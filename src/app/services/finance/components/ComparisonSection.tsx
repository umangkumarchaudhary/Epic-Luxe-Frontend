...
export default function FinanceComparisonSection() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Hook your backend API here later
            ...
            <div className="px-8 pt-8 pb-4 overflow-y-auto flex-1 space-y-4">
              ...
              {formSubmitted ? (
                <div className="text-center mt-8">
                  ...
                  <p className="text-gray-300 mb-6">Our finance experts will contact you soon to assist.</p>
                </div>
              ) : (
                <form className="space-y-4" onSubmit={handleSubmit} noValidate>
                  ...
                  <div>
                    <label htmlFor="name" className="block text-sm font-light mb-1 text-[#BFA980]">
                      Name <span className="text-[#777]" title="Required">*</span>
                    </label>
                    <input
                      id="name"
                      name="name"
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-light mb-1 text-[#BFA980]">
                      Phone Number <span className="text-[#777]" title="Required">*</span>
                    </label>
                    <input
                      id="phone"
                      name="phone"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#D4AF37] to-[#BFA980] text-black py-3 rounded-lg font-semibold hover:from-[#BFA980] hover:to-[#D4AF37] transition shadow-md hover:shadow-[#D4AF37]/40"
                  >
                    Submit Application
                  </button>
                </form>
            ...
            {!formSubmitted && (
              <div className="w-full bg-black border-t border-[#BFA980] px-8 py-4 flex justify-center items-center text-sm text-[#BFA980] font-light sticky bottom-0 z-10">
                <button
                  ...
                  className="inline-block px-6 py-2 border border-[#D4AF37] rounded-full font-semibold hover:bg-[#1a1a1a] transition"
                  type="button"
                >
