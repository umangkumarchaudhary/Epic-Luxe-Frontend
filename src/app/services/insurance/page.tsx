  ...
  const faqs = [
    {
      ...
      answer: 'Yes, luxury cars require specialized coverage due to higher repair costs, premium parts, and advanced technology. Our plans are specifically designed for high-end vehicles with appropriate IDV and comprehensive add-ons.'
    },
    {
      question: 'Can I get zero depreciation on a 5-year-old Mercedes?',
      answer: 'Absolutely! We offer zero depreciation coverage for luxury cars up to 7 years old, depending on the insurer and vehicle condition. Our partners specialize in premium vehicle coverage.'
    },
    {
      question: 'Can I renew a lapsed policy here?',
      answer: 'Yes, we can help renew lapsed policies. However, a fresh inspection might be required, and there could be a waiting period for certain coverages. Contact our experts for personalized assistance.'
    },
    {
      question: 'What makes Epic Luxe insurance different?',
      answer: 'We specialize in luxury and premium vehicles, offer tailored coverage options, have partnerships with top insurers, provide concierge-level service, and understand the unique needs of high-end car owners.'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a1a] to-[#0e0e0e] text-white">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div 
            className={`text-center transition-all duration-1000 ${isVisible[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            ...
            <p className="text-xl md:text-2xl text-white/70 font-clean mb-8 max-w-3xl mx-auto">
              Get tailored protection for your premium pre-owned car — in minutes
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-white/70 font-clean">
              Smart pricing for luxury vehicles
            </p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div 
            className={`text-center mb-12 transition-all duration-1000 ${isVisible[3] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white/90 font-headline">
              Compare Top <span className="text-[#D4AF37]">Insurance Partners</span>
            </h2>
            <p className="text-xl text-white/70 font-clean">
              Compare quotes from leading providers in one click
            </p>
          </div>

          <div 
            className={`bg-gradient-to-br from-[#1a1a1a] to-[#0e0e0e] rounded-3xl p-8 border border-[#D4AF37]/20 transition-all duration-1000 delay-200 ${isVisible[3] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div 
            className={`text-center mb-16 transition-all duration-1000 ${isVisible[4] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white/90 font-headline">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div 
            className={`text-center mb-16 transition-all duration-1000 ${isVisible[5] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white/90 font-headline">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div 
                key={index}
                className={`bg-gradient-to-br from-[#1a1a1a] to-[#0e0e0e] rounded-2xl p-8 border border-[#D4AF37]/20 hover:border-[#D4AF37]/40 transition-all duration-500 ${isVisible[5] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div 
            className={`text-center mb-16 transition-all duration-1000 ${isVisible[6] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white/90 font-headline">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div 
                key={index}
                className={`bg-gradient-to-br from-[#1a1a1a] to-[#0e0e0e] rounded-xl border border-[#D4AF37]/20 overflow-hidden transition-all duration-500 ${isVisible[6] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                style={{ transitionDelay: `${index * 100}ms` }}
              >
                <button
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div 
            className={`bg-gradient-to-r from-[#D4AF37]/10 via-[#D4AF37]/5 to-[#D4AF37]/10 border-2 border-[#D4AF37]/30 rounded-3xl p-12 text-center backdrop-blur-sm transition-all duration-1000 ${isVisible[7] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
