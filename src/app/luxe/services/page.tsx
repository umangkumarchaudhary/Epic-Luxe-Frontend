      ...
      <div className="min-h-screen bg-black font-primary">
        ...
        {showConsultationForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div className="relative bg-gradient-to-br from-[#1a1a1a] to-[#0e0e0e] border border-[#D4AF37]/30 rounded-2xl max-w-md w-full p-8 shadow-xl shadow-[#D4AF37]/10">
              <button
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 bg-white/10 text-white placeholder-white/60 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D4AF37] ${
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${
                      isSubmitting
                        ...
                        : 'bg-gradient-to-r from-[#D4AF37] to-[#BFA980] hover:shadow-lg hover:shadow-[#D4AF37]/20'
                    }`}
                  >
                    {isSubmitting ? (
                      'Submitting...'
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-white/70 mb-4 leading-relaxed font-light text-sm">{service.summary}</p>
                    <p className="text-white/60 text-xs mb-6 leading-relaxed font-light">{service.description}</p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  <p className="text-white/80 mb-6 italic leading-relaxed font-light">&quot;{testimonial.content}&quot;</p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="border-2 border-[#D4AF37] text-[#D4AF37] font-semibold py-4 px-8 rounded-xl hover:bg-[#D4AF37] hover:text-black transition-all duration-300"
              >
