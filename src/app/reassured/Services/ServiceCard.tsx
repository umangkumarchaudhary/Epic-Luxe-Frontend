...
const ServiceCard = memo(({ service, index }: ServiceProps) => {
  ...
  return (
    <div
      id={service.id}
      className={`group relative overflow-hidden bg-white border border-gray-200 hover:border-gray-400 transition-all duration-300 hover:shadow-xl ${
        isVisible ? 'animate-fade-in-up' : 'opacity-0'
      }`}
      style={{
        animationDelay: `${index * 0.05}s`, // Reduced delay for faster animations
      }}
    >
      {/* Background Image */}
      ...
      <div className="p-8">
        ...
        <button 
          ...
          className="mercedes-button w-full bg-gray-800 text-white font-medium py-4 px-6 hover:bg-black transition-all duration-300 group"
        >
