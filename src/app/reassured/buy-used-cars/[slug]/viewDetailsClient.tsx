...
const EMIModal = dynamic(() => import('../buyComponents/EMIModal/EMIModal').then(mod => ({ default: mod.default })), {
  loading: () => <div className="animate-pulse bg-gray-800 rounded-lg h-32" />,
  ssr: false
});

const ScheduleDemo = dynamic(() => import('../buyComponents/Schedule').then(mod => ({ default: mod.default })), {
  loading: () => <div className="animate-pulse bg-gray-800 rounded-lg h-32" />,
  ssr: false
});
...
const ImageGallery = React.memo(({ images }: { images: VehicleImage[] }) => {
  ...
  return (
    <>
      ...
      {images.length > 1 && (
        <div className="flex gap-3 mt-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
      ...
      {showFullscreen && (
        <div 
          ...
          onClick={(e) => e.target === e.currentTarget && setShowFullscreen(false)}
        >
...
export default function ViewDetailsClient({ vehicleData }: Props) {
  ...
  ].filter(item => item.score != null), [vehicle]);
  ...
  useEffect(() => {
    const savedLiked = localStorage.getItem(`vehicle_liked_${vehicle.id}`);
    if (savedLiked) {
  ...
  useEffect(() => {
    localStorage.setItem(`vehicle_liked_${vehicle.id}`, JSON.stringify(liked));
  }, [liked, vehicle.id]);
    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 p-4 lg:p-8">
          <div className="bg-gradient-to-br from-black/90 to-gray-900/90 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-[#D4AF37]/20 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/3 to-transparent"></div>
            <div className="relative z-10 text-center">
              <div className="flex items-center justify-center gap-4 mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-[#D4AF37] to-[#BFA980] rounded-full flex items-center justify-center">
                  <Award className="w-8 h-8 text-black" />
                </div>
                <h2 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent font-manrope">
                  Luxury Experience Guaranteed
                </h2>
              </div>
              
              <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto font-manrope">
                Experience the pinnacle of automotive luxury with our certified pre-owned vehicles, backed by comprehensive warranties and unmatched service excellence.
              </p>
              
              <div className="grid md:grid-cols-4 gap-8 mb-12">
                <div className="text-center">
                  <div className="text-4xl font-bold bg-gradient-to-r from-[#D4AF37] to-[#BFA980] bg-clip-text text-transparent mb-2 font-manrope">10,000+</div>
                  <div className="text-gray-400 font-manrope">Luxury Clients</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold bg-gradient-to-r from-[#D4AF37] to-[#BFA980] bg-clip-text text-transparent mb-2 font-manrope">5,000+</div>
                  <div className="text-gray-400 font-manrope">Premium Vehicles</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold bg-gradient-to-r from-[#D4AF37] to-[#BFA980] bg-clip-text text-transparent mb-2 font-manrope">15+</div>
                  <div className="text-gray-400 font-manrope">Years Excellence</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold bg-gradient-to-r from-[#D4AF37] to-[#BFA980] bg-clip-text text-transparent mb-2 font-manrope">4.9</div>
                  <div className="text-gray-400 font-manrope">Luxury Rating</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button
                  onClick={openScheduleModal}
                  className="bg-gradient-to-r from-[#D4AF37] to-[#BFA980] text-black px-8 py-4 rounded-2xl font-bold hover:shadow-xl hover:shadow-[#D4AF37]/25 transition-all duration-300 hover:scale-105 font-manrope text-lg"
                >
                  Schedule Premium Test Drive
                </button>
                <button
                  onClick={handleCallDealer}
                  className="border-2 border-[#D4AF37] text-[#D4AF37] px-8 py-4 rounded-2xl font-bold hover:bg-[#D4AF37]/10 transition-all duration-300 hover:scale-105 font-manrope text-lg"
                >
